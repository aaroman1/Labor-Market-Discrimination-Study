---
title: 'Labor Market Discrimination Study'
output:
...
Constructing a logistic model to predict if the job applicant was called back using _experience_ as the predictor variable.
...
Plotting the raw data and the logistic curve on the same axes.
...
Predicting the probability of an applicant with 5 years of experience getting a callback.
...
Constructing an empirical logit plot.
...
Performing a hypothesis test to determine if there is significant evidence of a relationship between _call_ and _experience_.
...
Constructing a confidence interval for the odds ratio for your model.
...
For each 5-year increase in _experience_, predicting how the odds will change in the applicant getting a call back.
...
Constructing subsets of the data for each category of _ethnicity_ and construct logistic models to predict if the job applicant was called back using _experience_ as the predictor variable for each of these subsets. Then plotting the raw data and the logistic curves on the same axes.
...
Constructing subsets of the data for each category of _sex_ and logistic models to predict if the job applicant was called back using _experience_ as the predictor variable for each of these subsets. Then plotting the raw data and the logistic curves on the same axes.
